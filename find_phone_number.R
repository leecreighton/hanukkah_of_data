...
#Vectorize the translate_name_to_number() function
translate_name_to_number_v <- Vectorize(translate_name_to_number) 
...
the_answer <- customers |>
  ...
  mutate(computed_phone_number = translate_name_to_number_v(last_name)) |> 
  #4. Find the answer!
